...
export const getListProductsQueryKey = (params) => {
  return [`/api/products`, ...(params ? [params] : [])];
};
 ...
 */
export const getGetProductUrl = (id) => `/api/products/${id}`;
...
export const getGetProductQueryKey = (id) => [`/api/products/${id}`];
 ...
 */
export const getUpdateProductUrl = (id) => `/api/products/${id}`;
 ...
 */
export const getDeleteProductUrl = (id) => `/api/products/${id}`;
 ...
 */
export const getCreateCategoryUrl = () => `/api/categories`;
 ...
 */
export const getDeleteCategoryUrl = (id) => `/api/categories/${id}`;
...
export const getListBannersQueryKey = () => [`/api/banners`];
...
export const useCreateBanner = (options) => {
  ...
  const mutationFn = (props) => {
    const { data } = props ?? {};
    return customFetch(`/api/banners`, {
      ...options?.request,
      method: "POST",
...
export const useUpdateBanner = (options) => {
  ...
  const mutationFn = (props) => {
    const { id, data } = props ?? {};
    return customFetch(`/api/banners/${id}`, {
      ...options?.request,
      method: "PUT",
      headers: { "Content-Type": "application/json", ...options?.request?.headers },
      body: JSON.stringify(data),
...
export const getSendVerificationCodeUrl = () => "/api/auth/send-code";
...
export const getVerifyCodeUrl = () => "/api/auth/verify-code";
...
export const getLoginAdminUrl = () => "/api/auth/login";
...
export const getListUsersUrl = () => "/api/users";
...
export const getUpdateUserRoleUrl = (id) => `/api/users/${id}/role`;
...
export const getGetUserOrdersQueryKey = () => ["/api/users/me/orders"];
...
export const getGetUserOrdersUrl = () => "/api/users/me/orders";